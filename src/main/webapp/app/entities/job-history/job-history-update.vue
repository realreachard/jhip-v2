  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jHipV2App.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="$t('jHipV2App.jobHistory.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jHipV2App.jobHistory.startDate')" for="job-history-startDate">Start Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jHipV2App.jobHistory.endDate')" for="job-history-endDate">End Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jHipV2App.jobHistory.language')" for="job-history-language">Language</label>
            <select
              class="form-control"
              name="language"
              ...
              data-cy="language"
            >
              <option value="FRENCH" v-bind:label="$t('jHipV2App.Language.FRENCH')">FRENCH</option>
              <option value="ENGLISH" v-bind:label="$t('jHipV2App.Language.ENGLISH')">ENGLISH</option>
              <option value="SPANISH" v-bind:label="$t('jHipV2App.Language.SPANISH')">SPANISH</option>
              <option value="CHINESE" v-bind:label="$t('jHipV2App.Language.CHINESE')">CHINESE</option>
            </select>
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jHipV2App.jobHistory.job')" for="job-history-job">Job</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jHipV2App.jobHistory.department')" for="job-history-department">Department</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jHipV2App.jobHistory.employee')" for="job-history-employee">Employee</label>
