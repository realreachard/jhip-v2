  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jHipV2App.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="$t('jHipV2App.department.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jHipV2App.department.departmentName')" for="department-departmentName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jHipV2App.department.location')" for="department-location">Location</label>
